<div class="slider-outer-shadow rounded-4xl bg-tictac-primary-blue relative mb-10 w-[60vw] max-w-4xl p-2">
    <form wire:submit="{{ $isLoginForm ? 'login' : 'register' }}">
            ...
            <div class='text-tictac-primary-blue grid grid-cols-[1fr_auto_1fr] gap-4'>
                <div class="flex flex-col gap-4">
                    <div class="flex items-end">
                        ...
                        <span>/</span>
                        <span class="text-center" wire:click='toggleForm'>
        ...
        <button
            class="slider-outer-shadow font-super-comic bg-tictac-primary-blue absolute -bottom-4 left-1/2 block min-w-fit -translate-x-1/2 cursor-pointer overflow-clip rounded-full p-2 text-center"
            type="submit">
