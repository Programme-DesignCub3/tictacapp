...
<link href="https://fonts.googleapis.com/css2?family=Bangers&family=Comic+Neue:ital,wght@0,300;0,400;0,700;1,300;1,400;1,700&family=Passion+One:wght@400;700;900&family=Roboto:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
            ...
            <div class="flex justify-between items-center content-center clamp-[gap,2,4]">
                    ...
                    <x-modal model="openAuth">
                        <x-slot:trigger>
                            <div class="flex items-center gap-2 cursor-pointer">
                                ...
                                <span class="font-passion">Login</span>
                            </div>
                        </x-slot:trigger>
                ...
                @auth('web')
                    <div class="flex items-center gap-2">
                        <span class="font-passion text-white">Logged in as {{ explode(' ', auth('web')->user()->name)[0] }}</span>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button class="font-passion text-tictac-secondary-yellow hover:text-tictac-primary-blue cursor-pointer"
                                type="submit">
                                Logout
                            </button>
                        </form>
